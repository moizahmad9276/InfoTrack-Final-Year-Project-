...
public class LightblueFacultyroomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightblue_facultyroom);

        facultyroom = FirebaseDatabase.getInstance().getReference().child("beacon_lightblue").child("facultyroom");
