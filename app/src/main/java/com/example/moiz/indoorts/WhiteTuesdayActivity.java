...
import com.example.moiz.indoorts.WhiteTabs.WhiteTuesdayClassroomFragment;

public class WhiteTuesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_tuesday);
        ...
        viewPagerAdapter.AddFragment(new WhiteTuesdayClassroomFragment(), "CLASS ROOMS");
