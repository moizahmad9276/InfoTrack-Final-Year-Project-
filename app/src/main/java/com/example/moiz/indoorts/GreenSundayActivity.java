...
import com.example.moiz.indoorts.GreenTabs.GreenSundayClassroomFragment;

public class GreenSundayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_sunday);
        ...
        viewPagerAdapter.AddFragment(new GreenSundayClassroomFragment(), "CLASS ROOMS");
