...
import com.example.moiz.indoorts.WhiteTabs.WhiteWednesdayClassroomFragment;

public class WhiteWednesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_wednesday);
        ...
        viewPagerAdapter.AddFragment(new WhiteWednesdayClassroomFragment(), "CLASS ROOMS");
