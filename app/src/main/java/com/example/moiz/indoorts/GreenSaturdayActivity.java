...
import com.example.moiz.indoorts.GreenTabs.GreenSaturdayClassroomFragment;

public class GreenSaturdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_saturday);
        ...
        viewPagerAdapter.AddFragment(new GreenSaturdayClassroomFragment(), "CLASS ROOMS");
