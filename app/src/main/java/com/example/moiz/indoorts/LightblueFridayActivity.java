...
import com.example.moiz.indoorts.LightblueTabs.LightblueFridayClassroomFragment;
...
public class LightblueFridayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightblue_friday);
        ...
        viewPagerAdapter.AddFragment(new LightblueFridayClassroomFragment(), "CLASS ROOMS");
