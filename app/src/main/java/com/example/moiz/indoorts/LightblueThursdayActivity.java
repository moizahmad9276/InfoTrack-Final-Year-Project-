...
import com.example.moiz.indoorts.LightblueTabs.LightblueThursdayClassroomFragment;

public class LightblueThursdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightblue_thursday);
        ...
        viewPagerAdapter.AddFragment(new LightblueThursdayClassroomFragment(), "CLASS ROOMS");
