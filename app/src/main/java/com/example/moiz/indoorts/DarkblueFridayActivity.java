...
import com.example.moiz.indoorts.DarkblueTabs.DarkblueFridayClassroomFragment;
...
public class DarkblueFridayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_darkblue_friday);
        ...
        viewPagerAdapter.AddFragment(new DarkblueFridayClassroomFragment(), "CLASS ROOMS");
