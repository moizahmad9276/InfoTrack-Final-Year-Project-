...
import com.example.moiz.indoorts.DarkblueTabs.DarkblueSaturdayClassroomFragment;

public class DarkblueSaturdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_darkblue_saturday);
        ...
        viewPagerAdapter.AddFragment(new DarkblueSaturdayClassroomFragment(), "CLASS ROOMS");
