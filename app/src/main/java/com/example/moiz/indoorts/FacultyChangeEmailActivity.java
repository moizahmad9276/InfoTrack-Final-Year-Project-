...
public class FacultyChangeEmailActivity extends AppCompatActivity implements ConfirmPasswordDialog.onConfirmPasswordListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_change_email);
    ...
    private void saveEmailSettings(){
        ...
        if(!mFacultySettings.getFaculty().getEmail().equals(email)){
            FacultyEditProfileFragment fragment = new FacultyEditProfileFragment();
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.container, fragment);
            transaction.commit();
            Toast.makeText(FacultyChangeEmailActivity.this, "Verification email has been sent", Toast.LENGTH_SHORT).show();
        }
        else{
            FacultyEditProfileFragment fragment = new FacultyEditProfileFragment();
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.container, fragment);
            transaction.commit();
            Toast.makeText(FacultyChangeEmailActivity.this, "Email is already is use", Toast.LENGTH_SHORT).show();
        }
    }
