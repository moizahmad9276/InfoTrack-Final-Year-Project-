...
import com.example.moiz.indoorts.WhiteTabs.WhiteThursdayClassroomFragment;

public class WhiteThursdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_thursday);
        ...
        viewPagerAdapter.AddFragment(new WhiteThursdayClassroomFragment(), "CLASS ROOMS");
