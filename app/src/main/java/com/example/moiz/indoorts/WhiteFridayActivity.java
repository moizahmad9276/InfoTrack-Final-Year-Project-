...
import com.example.moiz.indoorts.WhiteTabs.WhiteFridayClassroomFragment;
...
public class WhiteFridayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_friday);
        ...
        viewPagerAdapter.AddFragment(new WhiteFridayClassroomFragment(), "CLASS ROOMS");
