...
public class GreenFacultyroomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_facultyroom);

        facultyroom = FirebaseDatabase.getInstance().getReference().child("beacon_green").child("facultyroom");
