...
import com.example.moiz.indoorts.LightblueTabs.LightblueMondayClassroomFragment;
import com.example.moiz.indoorts.LightblueTabs.LightblueOthersFragment;

public class LightblueMondayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightblue_monday);
        ...
        viewPagerAdapter.AddFragment(new LightblueMondayClassroomFragment(), "CLASS ROOMS");
