...
public class LightblueClassroomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightblue_classroom);

        sunday = FirebaseDatabase.getInstance().getReference().child("beacon_lightblue").child("classroom").child("sunday");
        monday = FirebaseDatabase.getInstance().getReference().child("beacon_lightblue").child("classroom").child("monday");
        tuesday = FirebaseDatabase.getInstance().getReference().child("beacon_lightblue").child("classroom").child("tuesday");
        wednesday = FirebaseDatabase.getInstance().getReference().child("beacon_lightblue").child("classroom").child("wednesday");
        thursday = FirebaseDatabase.getInstance().getReference().child("beacon_lightblue").child("classroom").child("thursday");
        friday = FirebaseDatabase.getInstance().getReference().child("beacon_lightblue").child("classroom").child("friday");
        saturday = FirebaseDatabase.getInstance().getReference().child("beacon_lightblue").child("classroom").child("saturday");
