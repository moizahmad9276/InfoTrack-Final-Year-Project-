...
import com.example.moiz.indoorts.LightblueTabs.LightblueSundayClassroomFragment;

public class LightblueSundayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightblue_sunday);
        ...
        viewPagerAdapter.AddFragment(new LightblueSundayClassroomFragment(), "CLASS ROOMS");
