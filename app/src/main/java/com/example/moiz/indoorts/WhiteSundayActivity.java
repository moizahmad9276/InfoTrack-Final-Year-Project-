...
import com.example.moiz.indoorts.WhiteTabs.WhiteSundayClassroomFragment;

public class WhiteSundayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_sunday);
        ...
        viewPagerAdapter.AddFragment(new WhiteSundayClassroomFragment(), "CLASS ROOMS");
