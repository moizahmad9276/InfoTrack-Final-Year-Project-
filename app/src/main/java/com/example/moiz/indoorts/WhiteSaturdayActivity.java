...
import com.example.moiz.indoorts.WhiteTabs.WhiteSaturdayClassroomFragment;

public class WhiteSaturdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_saturday);
        ...
        viewPagerAdapter.AddFragment(new WhiteSaturdayClassroomFragment(), "CLASS ROOMS");
