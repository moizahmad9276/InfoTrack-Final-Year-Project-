...
public class FacultyLogoutActivity extends AppCompatActivity {

    private static final String TAG = "FacultyLogoutActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_logout);
