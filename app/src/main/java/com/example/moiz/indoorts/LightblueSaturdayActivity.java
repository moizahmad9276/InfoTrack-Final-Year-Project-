...
import com.example.moiz.indoorts.LightblueTabs.LightblueSaturdayClassroomFragment;

public class LightblueSaturdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightblue_saturday);
        ...
        viewPagerAdapter.AddFragment(new LightblueSaturdayClassroomFragment(), "CLASS ROOMS");
