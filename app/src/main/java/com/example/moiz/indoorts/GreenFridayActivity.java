...
import com.example.moiz.indoorts.GreenTabs.GreenFridayClassroomFragment;
...
public class GreenFridayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_friday);
        ...
        viewPagerAdapter.AddFragment(new GreenFridayClassroomFragment(), "CLASS ROOMS");
