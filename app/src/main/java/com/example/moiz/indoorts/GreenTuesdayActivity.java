...
import com.example.moiz.indoorts.GreenTabs.GreenTuesdayClassroomFragment;

public class GreenTuesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_tuesday);
        ...
        viewPagerAdapter.AddFragment(new GreenTuesdayClassroomFragment(), "CLASS ROOMS");
