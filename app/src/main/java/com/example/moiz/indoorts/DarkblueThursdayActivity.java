...
import com.example.moiz.indoorts.DarkblueTabs.DarkblueThursdayClassroomFragment;

public class DarkblueThursdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_darkblue_thursday);
        ...
        viewPagerAdapter.AddFragment(new DarkblueThursdayClassroomFragment(), "CLASS ROOMS");
