...
import com.example.moiz.indoorts.GreenTabs.GreenWednesdayClassroomFragment;

public class GreenWednesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_wednesday);
        ...
        viewPagerAdapter.AddFragment(new GreenWednesdayClassroomFragment(), "CLASS ROOMS");
