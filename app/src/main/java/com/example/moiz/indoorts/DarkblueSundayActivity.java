...
import com.example.moiz.indoorts.DarkblueTabs.DarkblueSundayClassroomFragment;

public class DarkblueSundayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_darkblue_sunday);
        ...
        viewPagerAdapter.AddFragment(new DarkblueSundayClassroomFragment(), "CLASS ROOMS");
